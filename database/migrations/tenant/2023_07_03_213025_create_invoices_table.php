...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('invoices', function (Blueprint $table) {
            ...
            $table->decimal('credit_memos', 30, 6);
            $table->decimal('discounts', 30, 6);
            ...
            $table->string('periodicity', 25);
            $table->string('months', 25);
            $table->string('affected', 25);
            $table->string('sender_claim', 25);
            $table->string('claim_number', 25);
            $table->softDeletes();
            $table->timestamps();
