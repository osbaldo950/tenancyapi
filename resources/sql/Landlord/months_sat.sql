...
--
-- Table structure for table `months_sat`
--

-- DROP TABLE IF EXISTS `months_sat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
-- CREATE TABLE `months_sat` (
